...
public class MazeBuilder implements Runnable {
	...
	//Testing variables TODO
	public static BSPBuilder bTest;
	public static BSPNode rootTest;
	// constants
	...
	public void run() {
		...
		try {
			...
			//variables used for testing TODO
			bTest = b;
			rootTest = root;
	...
	*/
	...
	/**
	 * Return the SingleRandom object TODO
	 * @return 
	 */
	protected SingleRandom getSingleRandom() {
		return this.random;
	}
	/**
	 * Return the BSPBuilder for testing TODO
	 * @return
	 */
	protected BSPBuilder getBSPBuilder() {
		return this.bTest;
	}
