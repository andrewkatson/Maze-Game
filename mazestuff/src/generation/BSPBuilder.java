...
public class BSPBuilder {
	...
	//Test variables TODO
	private static ArrayList<Seg> testlsl;
	private static ArrayList<Seg> testrsl;
	private static BSPBranch testBranch;
	...
	private BSPNode genNodes(ArrayList<Seg> sl) throws InterruptedException {
		...
		BSPBranch returnthis = new BSPBranch(x, y, dx, dy, genNodes(lsl), genNodes(rsl)); // recursion on both branches TODO
		testBranch = returnthis;
		return returnthis; //delete returnthis and make the whole new... here
	}
	...
	/**
	 * Test function to return an Arraylist of the left hand side segments TODO
	 * @return
	 */
	protected ArrayList<Seg> getLSL(){
		return this.testlsl;
	}
	/**
	 * Test function to return an Arraylist of the right hand side segments TODO
	 * @return
	 */
	protected ArrayList<Seg> getRSL(){
		return this.testrsl;
	}
	/**
	 * Test function to return a BSPBranch 
	 * @return
	 */
	protected BSPBranch getBranch() {
