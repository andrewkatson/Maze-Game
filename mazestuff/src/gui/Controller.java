...
public class Controller {
    ...
    public void setMazeConfiguration(MazeConfiguration config) {
    	((StatePlaying)states[2]).setMazeConfiguration(config);
    }
     ...
     * @param ypos
     */
    public void setCurrentPosition(int xpos, int ypos) {
    	((StatePlaying)states[2]).setCurrentPosition(xpos, ypos);
    }
    
    /**
     * Sets the current position with an array
     * @param posArray
     */
    public void setCurrentPosition(int[] posArray) {
    	((StatePlaying)states[2]).setCurrentPosition(posArray[0], posArray[1]);
    }
