...
public class StatePlaying extends DefaultState {
    ...
    public void start(Controller controller, MazePanel panel) {
        ...
        Robot robot = this.control.getRobot();
        RobotDriver driver = this.control.getDriver();
        ...
        if(robot != null  && driver != null){
			...
			if(win) {
				...
				this.control.switchFromPlayingToWinning(driver.getPathLength(), driver.getEnergyConsumption());
			}
        }
    }
    /**
