...
public interface State {
    ...
    /**
     * Sets the energy consumed through the solution of
     * maze by the robot driver. Interest to the final 
     * screen.
     * @param pathLength walked through the maze
     * @param energyConsumption through the maze
     */
    void setEnergyConsumption(float energy);
